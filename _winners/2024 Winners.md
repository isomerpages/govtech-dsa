...
<div role="navigation" id="toc-panel">
  ...
  <ul class="toc-links">
    ...
    <li><a href="#mmow">Most Mobile Optimised</a></li>
...
<div class="row is-multiline">
  ...
  <div class="col is-9">
      <div class="classification">Winner</div>
    <div class="winner has-text-left">XXXX</div>
    <p class="margin--top--none"><a href="https://cpf.gov.sg" target="_blank">https://xxxx</a></p>
  </div>
    <div class="col is-3">
    <p><strong>Honourable Mention</strong></p>
  </div>
  <div class="col is-5">
    <div class="winner has-text-left">XXXXXX</div>
    <p class="margin--top--none"><a target="_blank" href="https://imda.gov.sg">https://xxxxxx.gov.sg</a></p>
  </div>
  <div class="col is-4">
    <div class="winner has-text-left">XXXXXXXX</div>
    <p class="margin--top--none"><a target="_blank" href="http://ica.gov.sg">http:/xxxxx.gov.sg</a></p>
  </div>
</div>
...
<div class="row is-multiline">
  ...
  <div class="col is-9">
    ...
    <p class="margin--top--none"><a href="https://dbs.com/default.page" target="_blank">https://xxxxxx</a></p>
  </div>
    <div class="col is-3">
    <p><strong>Honourable Mention</strong></p>
  </div>
  <div class="col is-4">
    <div class="winner has-text-left">XXXXXXXX</div>
    <p class="margin--top--none"><a target="_blank" href="https://gardensbythebay.com.sg">https://xxxxxxx</a></p>
  </div>
  <div class="col is-4">
    <div class="winner has-text-left">XXXXXXXX</div>
    <p class="margin--top--none"><a target="_blank" href="https://thesmartlocal.com">https://xxxxxx</a></p>
  </div>
</div>
<hr>
